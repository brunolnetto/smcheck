...
def check_business_rules(
    ...
    **Best Practice:** Keep your business rules in a single location (e.g., a
    ``## Business Rules`` section in your README.md), so they can be:

    1. Checked against the machine implementation using this function
    2. Documented for users and stakeholders
    3. Referenced by acceptance tests and specification documents

    This creates a single source of truth for the expected behaviour.

    Parameters
    ----------
    business_rules:
        Free-form text description of the expected behaviour — can be a product
        spec, a PRD excerpt, a bullet list, or prose narrative. Often sourced
        directly from your project's README or specification document.
    sm_class:
